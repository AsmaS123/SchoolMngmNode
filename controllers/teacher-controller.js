...
const updateTeacher = async(req,res,next) =>{
 ...
 const getAllTeachersTimetable = async(req,res,next) =>{
    ...
    try{
        ...
        const loolupresult = await Timetable.aggregate([
            {
            $lookup: {
                from : 'classrooms',
            ...
            {
                $unwind: '$classroomsDetails' // Unwind customerDetails array
              },
            //   {
            //     $lookup: {
            //         from : 'classrooms',
            ...
            //   },
            //   {
            //     $unwind: '$teachersDetails' // Unwind customerDetails array
            //   },
              {
                $project: {
                    day:1,
        ...
        return res.status(200).json({ loolupresult });
    }
    catch(err){
        console.log(err);
        return res.status(400).json({message: "Incorrect data!"});
